		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3 partner">
					...
					<img src="<?=base_url("images/support/u_faridas.png")?>" class="l-inner" alt="faridas"/> </a>	
					</center>
				</div>
				<div class="col-md-3 partner">
					<center class="p-inner">
					<a href="http://desyinof.com" target="_blank">
					<img src="<?= base_url("images/support/u_desyinof.png")?>" class="l-inner" alt="desyinof"/> </a>	
					</center>
				</div>
				<div class="col-md-3 partner">
					<center class="p-inner">
				...
				<div class="col-md-3 partner">
					...
					<img class="l-inner" src="<?= base_url("images/support/u_fapermata.png")?>" alt="desyinof"/> </a>	
					</center>
				</div>
				<?php } ?>
