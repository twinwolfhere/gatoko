        ...
        <div class="col-md-10" style="margin-top:8px;">
            <form method="get" id="form-seleksi" action="../../list.php">
                <div class="col-md-5" style="padding-right:2px; padding-left:2px;margin-top:4px;">
                    <input type="text" placeholder="Masukan nama produk yang akan dicari | Selamat berbelanja"
                           name="tag" id="input" class="form-control" placeholder="cari  nama">
                </div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <a href="admin.php" class="menu-admin">Konfigurasi Toko</a>
        ...
        <div class="panel-body">
            <div class="col-md-3">
                ...
                <form id="imageform" method="post" enctype="multipart/form-data" action='ajaximage.php'>
                    <div id='preview'>
                        <img src="../foto_member/<?= $this->session->userdata('foto'); ?>"/>
                    </div>
					<span class="btn btn-default btn-file">
					<img src="browse.png" class="browse"/>
            ...
            <div class="col-md-9">
                <form action="profil_proses.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="password" name="pass" id="pass" class="ui-text" style="width:200px"
                           value="<?= $this->session->userdata('password'); ?>" required/><br><br>
                    <label>Re-Password </label><br>
                    <input type="password" name="pass2" id="pass2" class="ui-text" style="width:200px"
                           value="<?= $this->session->userdata('password'); ?>" onchange="cekpassword(this.value)" required/>
                    ...
                    <div class="col-md-4" style="padding:0;">
                        ...
                        <select name="kota" id="kota" onchange="ajaxkec(this.value)" class="combo">
                            <option value="<?= $kota; ?>"><?= $this->session->userdata('kota'); ?></option>
                        </select>
                    </div>
                    <div class="col-md-4" style="padding:0;">
                    </div>
                    ...
                    <textarea name="ket" class="ui-text" style="height:150px !important; width:80% !important;"
                              required> <?= $this->session->userdata('keterangan'); ?> </textarea><br>
                    <br>
                    ...
                    <br>
                    <input type="checkbox" name="agreement" required/> Apakah anda sudah menyetujui <a href="">terms and
                        condition</a><br><br>
