...
class User_model extends CI_Model
{
        ...
        if ($query->num_rows() > 0) {
            foreach ($query->result() as $rows) {
                ...
                $newdata = array(
                    ...
                    'user_name' => $rows->nama,
                    'no_identitas' => $rows->no_identitas,
    ...
    function kode_prop_lain($prop)
    {
        ...
        elseif ($prop == 9) {
            $kp['olx'] = "jawa barat";
            $kp["kaskus"] = "jawa barat";
        }//jawa barat
        elseif ($prop == 10) {
            $kp['olx'] = "jawa tengah";
            $kp["kaskus"] = "jawa tengah";
        }//jawa tengah
        elseif ($prop == 11) {
            $kp['olx'] = "jawa timur";
            $kp["kaskus"] = "jawa timur";
        }//jawa timur
        elseif ($prop == 12) {
            $kp['olx'] = "kalimantan barat";
            $kp["kaskus"] = "kalimantan barat";
        }//kalimantan barat
        elseif ($prop == 13) {
            $kp['olx'] = "kalimantan selatan";
            $kp["kaskus"] = "kalimantan selatan";
        }//kalimantan selatan
        elseif ($prop == 14) {
            $kp['olx'] = "kalimantan tengah";
            $kp["kaskus"] = "kalimantan tengah";
        }//kalimantan tengah
        elseif ($prop == 15) {
            $kp['olx'] = "kalimantan timur";
            $kp["kaskus"] = "kalimantan timur";
        }//kalimantan timur
        elseif ($prop == 16) {
            $kp['olx'] = "lampung";
            $kp["kaskus"] = "lampung";
        ...
        elseif ($prop == 18) {
            $kp['olx'] = "maluku utara";
            $kp["kaskus"] = "maluku utara";
        }//maluku utara
        elseif ($prop == 19) {
            $kp['olx'] = "nusa tenggara barat";
            $kp["kaskus"] = "nusa tenggara barat";
        }//NTB
        elseif ($prop == 20) {
            $kp['olx'] = "nusa tenggara timur";
            $kp["kaskus"] = "nusa tenggara timur";
        }//NTT
        elseif ($prop == 21) {
            $kp['olx'] = "papua barat";
            $kp["kaskus"] = "papua barat";
        }//papua barat
        elseif ($prop == 22) {
            $kp['olx'] = "papua";
            $kp["kaskus"] = "papua";
        ...
        elseif ($prop == 25) {
            $kp['olx'] = "sulawesi selatan";
            $kp["kaskus"] = "sulawesi selatan";
        }//sulawesi selatan
        elseif ($prop == 26) {
            $kp['olx'] = "sulawesi tengah";
            $kp["kaskus"] = "sulawesi tengah";
        }//sulawesi tengah
        elseif ($prop == 27) {
            $kp['olx'] = "sulawesi tenggara";
            $kp["kaskus"] = "sulawesi tenggara";
        }//sulawesi tenggara
        elseif ($prop == 28) {
            $kp['olx'] = "sulawesi utara";
            $kp["kaskus"] = "sulawesi utara";
        }//sulawesi utara
        elseif ($prop == 29) {
            $kp['olx'] = "sumatra barat";
            $kp["kaskus"] = "sumatera barat";
        }//sumatera barat
        elseif ($prop == 30) {
            $kp['olx'] = "sumatra selatan";
            $kp["kaskus"] = "sumatera selatan";
        }//sumatera selatan
        elseif ($prop == 31) {
            $kp['olx'] = "sumatra utara";
            $kp["kaskus"] = "sumatera utara";
        }//sumatera utara
        elseif ($prop == 32) {
            $kp['olx'] = "yogyakarta";
            $kp["kaskus"] = "yogyakarta";
        }//DI. Yogyakarta
        elseif ($prop == 33) {
            $kp['olx'] = "sulawesi barat";
            $kp["kaskus"] = "sulawesi barat";
        }//sulawesi barat
        elseif ($prop == 34) {
            $kp['olx'] = "kepulauan riau";
            $kp["kaskus"] = "kepulauan riau";
        }//Kepulauan riau
        else {
            $kp['olx'] = "";
        }
    ...
    function get_kategori($kategori)
    {
        ...
        elseif ($kategori == 4) {
            $kat['olx'] = "elektronik-gadget";
            $kat['kaskus'] = 317;
            $kat['tokopedia'] = 60;
        }//elektronik
        elseif ($kategori == 5) {
            $kat['olx'] = "elektronik-gadget/handphone";
            $kat['kaskus'] = 210;
            $kat['tokopedia'] = 65;
        }//gadget
        elseif ($kategori == 6) {
            $kat['olx'] = "rumah-tangga";
            $kat['kaskus'] = 296;
            $kat['tokopedia'] = 992;
        }//interior
        elseif ($kategori == 7) {
            $kat['olx'] = "keperluan-pribadi";
            $kat['kaskus'] = 196;
            $kat['tokopedia'] = 78;
        }//fashion
        elseif ($kategori == 8) {
            $kat['olx'] = "jasa-lowongan-kerja/jasa";
            $kat['kaskus'] = 202;
            $kat['tokopedia'] = 404;
        }//jasa
        else {
